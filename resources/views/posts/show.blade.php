...
@section('content')
    <article class="bg-cream p-6 rounded-lg shadow-md max-w-7xl mx-auto mt-8 flex flex-col md:flex-row gap-8" style="height: 75vh;">
        ...
        <!-- Section Article -->
        <div class="flex-1 w-full md:w-3/4 h-full overflow-auto flex flex-col">
            ...
            <footer class="text-sm text-gray-400 mt-auto">
                <div class="mt-2">
        ...
        <div class="w-full md:w-1/4 bg-neutral-800 text-gray-200 p-6 rounded-lg max-h-screen flex flex-col">
            <!-- Like -->
            <x-like-component :post="$post" />

            <div class="space-y-3 mb-6 overflow-y-auto" style="height: 35vh;">
